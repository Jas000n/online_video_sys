  ...
  <div class="Page Confirm">
    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
        ...
        <tr>
          <td colspan="3" class="teacher">创作者：{{order.producerName}}</td>
        </tr>
        <tr class="good">
          <td class="name First">
            <a target="_blank" :href="'https://localhost:3000/video/'+order.videoId">
              <img :src="order.videoCover"></a>
            <div class="goodInfo">
              <input type="hidden" class="ids ids_14502" value="14502">
              <a target="_blank" :href="'https://localhost:3000/video/'+ order.videoId">{{order.videoTitle}}</a>
            </div>
          </td>
          <td class="price">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《CiliCili购买协议》</a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
            <a :href="'/video/'+order.videoId">返回课程详情页</a>
          </div>
          <div class="fr">
